/*
 * DASHBOARD.JS - Teacher Dashboard JavaScript
 * Ito yung JS file para sa teacher dashboard page
 * 
 * Main features:
 * 1. Profile Menu Toggle - Para i-show/hide yung profile dropdown
 * 2. Right Sidebar Toggle - Para sa mobile responsive na sidebar
 * 
 * Note: Same functionality to sa student dashboard JS
 * Pwede to i-consolidate sa isang shared file in the future
 */
